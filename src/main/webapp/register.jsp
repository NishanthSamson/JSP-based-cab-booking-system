...
<body>
    ...
    <div class = "col-md-4">
        ...
        <form method="post">
            ...
            <button type="submit" class="btn btn-primary mt-2">Register Vehicle</button>
        </form>
        </div>
    </div>
    </div>
    ...
    if (request.getMethod().equalsIgnoreCase("post")) {
        ...
        try {
            ...
            String insertVehicleQuery = "INSERT INTO vehicles (registration_number, brand, model, capacity) VALUES (?, ?, ?, ?)";
            PreparedStatement vehicleStatement = connection.prepareStatement(insertVehicleQuery);
