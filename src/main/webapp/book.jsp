    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="Auto" name="vehicleType" value="Auto">
                <label class="form-check-label" for="Auto">Auto</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="sedan" name="vehicleType" value="Sedan">
                <label class="form-check-label" for="sedan">Sedan</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="suv" name="vehicleType" value="SUV">
                <label class="form-check-label" for="suv">SUV</label>
            </div>

            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" id="bike" name="vehicleType" value="Bike">
