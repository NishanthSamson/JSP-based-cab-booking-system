    ...
    <form action="/cab_booking/testdb" method="post">
      ...
      <div class="mb-3">
        ...
        <div class="form-check mb-2">
          <input class="form-check-input" type="radio" id="sedan" name="vehicle" value="Sedan" required>
          <label class="form-check-label" for="sedan">Sedan</label>
        </div>
        <div class="form-check mb-2">
          <input class="form-check-input" type="radio" id="suv" name="vehicle" value="SUV" required>
          <label class="form-check-label" for="suv">SUV</label>
        </div>
        <div class="form-check mb-2">
          <input class="form-check-input" type="radio" id="auto" name="vehicle" value="Auto" required>
          <label class="form-check-label" for="auto">Auto</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" id="bike" name="vehicle" value="Bike" required>
