    ...
    <%
        if (request.getMethod().equalsIgnoreCase("post")) {
            ...
            try {
                ...
                String sql = "SELECT * FROM bookings WHERE mobile = '" + mobile + "' AND id = " + id;
                resultSet = statement.executeQuery(sql);

                out.println("<h2 class='mt-5 mb-3'>Canceled Ride:</h2>");
                out.println("<table class='table table-bordered table-striped'>");
                out.println("<thead class='thead-dark'><tr><th>ID</th><th>Name</th><th>Mobile</th><th>Pickup</th><th>Destination</th><th>Vehicle</th></tr></thead><tbody>");
