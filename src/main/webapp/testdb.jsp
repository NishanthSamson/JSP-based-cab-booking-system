    ...
    <%
        ...
        try {
            ...
            if (request.getMethod().equalsIgnoreCase("post")) {
                ...
                String sql = "INSERT INTO bookings (name, mobile, pickup, destination, vehicle) VALUES ('" + name + "','" + mobile + "','" + pickup + "', '" + destination + "', '" + vehicle + "')";
                statement.executeUpdate(sql);

                resultSet = statement.executeQuery("SELECT * FROM bookings WHERE mobile = '" + mobile + "'");
            }
    %>
